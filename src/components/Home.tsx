    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex justify-center mt-7">
                ...
                <span className="ml-2 text-2xl font-bold text-white">{clickCount||0}</span>
                </div>
            </div>
